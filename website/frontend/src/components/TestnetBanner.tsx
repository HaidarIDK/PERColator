  ...
  const handleFaucetRequest = async () => {
    ...
    try {
      ...
      toast({
        ...
        message: '✅ Received 2 SOL from faucet!'
      })
      ...
      if (err.message?.includes('airdrop request limit')) {
        toast({
          type: 'error',
          title: 'Airdrop Limit',
          message: 'Airdrop limit reached. Try again in a few hours or use faucet.solana.com'
        })
      } else {
        toast({
          type: 'error',
          title: 'Airdrop Failed',
          message: 'Failed to request airdrop. Please try faucet.solana.com'
        })
      }
    } finally {
